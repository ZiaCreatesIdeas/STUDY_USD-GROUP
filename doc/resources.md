...
:::{card} Initial Studies

- [Five Things to Know About USD | NVIDIA Omniverse Tutorials](http://www.youtube.com/watch?v=vFxytzQlOEs)

- [Universal Scene Description (OpenUSD): 4 Superpowers to Get You Started](https://resources.nvidia.com/en-us-omniverse-usd/gtcspring21-s33133 "Learn about the 4 superpowers of OpenUSD")

- [Universal Scene Description (OpenUSD): Composition and Layering](https://www.youtube.com/watch?v=4)

- [Optional Reading](https://openusd.org/release/intro.html)  

:::

:::{card} What is USD?

- [USD DLI](https://courses.nvidia.com/courses/course-v1:DLI+S-FX-02+V1/) 
...
* [USD DLI - Fundamental Section](https://courses.nvidia.com/courses/course-v1:DLI+S-FX-02+V1/)
* [Defining Your First Prims Tutorial](https://docs.omniverse.nvidia.com/workflows/latest/openusd-developer/defining-your-first-prims.html)
* [Inspecting and Authoring Properties Tutorial](https://openusd.org/release/tut_inspect_and_author_props.html)
* [USDView Quickstart](https://docs.omniverse.nvidia.com/usdview/latest/quickstart.html#locating-usd-tutorial-content-and-examples)


:::


:::{card} Prims, Properties, and Metadata

* [Advanced Section](https://courses.nvidia.com/courses/course-v1:DLI+S-FX-02+V1/)
* [Traversing the Stage Tutorial](https://openusd.org/release/tut_traversing_stage.html)
* [USD View Documentation](https://docs.omniverse.nvidia.com/usdview/latest/index.html)

:::


:::{card} Stage Traversal and Inspection

* [What Makes USD Unique in NVDA](https://www.youtube.com/watch?v=o2x-30-PTkw) 

* [Explore USD Kitchen Set](https://openusd.org/release/dl_downloads.html)
...
* [Composition Puzzles](https://github.com/usd-wg/assets/tree/main/docs/CompositionPuzzles)
...
* [Explore Pixar City Set](https://openusd.org/release/dl_downloads.html)
...
* [Asset Structuring Guidelines](https://docs.omniverse.nvidia.com/usd/latest/learn-openusd/independent/asset-structure-principles.html)
* [Explore Example Datasets](https://docs.omniverse.nvidia.com/usd/latest/usd_content_samples/sample_content.html)

:::



:::{card} Asset Structure

* [Explore usd-plugin-schema](https://github.com/NVIDIA-Omniverse/usd-plugin-samples)
